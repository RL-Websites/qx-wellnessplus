...
interface StepThreeProps {
  handleBack: () => void;
  formData: any;
  handleSubmit: (medicineData: any) => void;
}
...
function StepThree({ handleBack, handleSubmit, formData }: StepThreeProps) {
  ...
  const handleMedicineSelect = (medicineData: any) => {
    handleSubmit(medicineData);
    // console.log("Root Level Parent", item);
    return;
    // if (id) {
    ...
    <>
        ...
        <div className="grid grid-cols-2 gap-6 pt-4">
          ...
          {medicines?.map((item) => (
            <ProductCard
              ...
              handleEPrescription={handleEPrescription}
      ...
      <div className="flex justify-between">
        <div className="flex gap-6 ms-auto">
          ...
          {/* <Button
            w={256}
            onClick={() => console.log("Prescribed Medication")}

...
function PatientDetailsPage({ label, path }: IBreadcrumb) {
              ...
              >
                <div className="xl:w-[415px] lg:w-[300px] flex flex-col gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="sm:w-[calc(100%_-_132px)] w-full extra-form-text-regular">{patient?.order_id || "N/A"}</span>
                  </div>
                  <div className="flex flex-wrap items-center gap-3">
                    <span className="sm:w-[120px] w-full extra-form-text-medium text-grey-medium">Order Qty:</span>
                    <span className="sm:w-[calc(100%_-_132px)] w-full extra-form-text-regular">{patient?.medication?.quantity || "N/A"}</span>
                  </div>
                </div>
                <div className="xl:w-[calc(100%_-_435px)] lg:w-[calc(100%_-_300px)] flex flex-wrap items-center gap-5">
                  <div className="flex flex-col gap-3 xl:w-[calc(100%_-_152px)] w-full">
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <span className="sm:w-[calc(100%_-_132px)] w-full extra-form-text-regular">{patient?.medication?.drug_name || "N/A"}</span>
                    </div>
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="sm:w-[120px] w-full extra-form-text-medium text-grey-medium">Drug No:</span>
                      <span className="sm:w-[calc(100%_-_132px)] w-full extra-form-text-regular">{patient?.medication?.drug_ndc || "N/A"}</span>
                    </div>
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="sm:w-[120px] w-full extra-form-text-medium text-grey-medium">Diagnosis:</span>
                      <span className="sm:w-[calc(100%_-_132px)] w-full extra-form-text-regular">{"N/A"}</span>
                    </div>
                  </div>
                  <Link

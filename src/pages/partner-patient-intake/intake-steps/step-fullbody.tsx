...
export const stepFullBodySchema = yup.object({
...
export type stepFullBodySchemaType = yup.InferType<typeof stepFullBodySchema>;

interface StepFullBodyProps {
  onNext: (data: stepFullBodySchemaType) => void;
  defaultValues?: stepFullBodySchemaType;
}

const StepFullBody = ({ onNext, defaultValues }: StepFullBodyProps) => {
  ...
  const {
    ...
    clearErrors,
    formState: { errors },
  } = useForm<stepFullBodySchemaType>({
    resolver: yupResolver(stepFullBodySchema),
    defaultValues: {},
  });
  ...
  return (
    <>
      <form
        ...
        className="card pt-10 space-y-10"
      >
        ...
        <div className="grid md:grid-cols-2 gap-6 pt-5">
          <div className="border-2 border-dashed border-tag-bg-deep bg-tag-bg p-4 rounded-md text-sm pb-20">
            <h6 className="heading-xxs text-tag-bg-deep pb-4">Full Body Photo Guideline</h6>
            <p className="text-fs-md pb-5 text-tag-bg-deep">
            ...
            <h6 className="heading-xxs text-tag-bg-deep pb-4">Tips for the Best Photo:</h6>
            <ul className="list-disc ps-5 space-y-1 text-tag-bg-deep">
            ...
            <h6 className="heading-xxs text-tag-bg-deep pb-4 pt-5">How to Take the Photo:</h6>
            <ul className="list-disc ps-5 space-y-1 text-tag-bg-deep">
            ...
            <h6 className="heading-xxs text-tag-bg-deep pb-4 pt-5">Privacy First:</h6>
            <ul className="list-disc ps-5 space-y-1 text-tag-bg-deep">
              ...
              {!fullBodyFile ? (
                <div className="pointer-events-none h-full flex justify-center">
                  <div className="flex flex-col items-center justify-center h-full">
                    <IconCloudUp size={30} />
                    <h6 className="text-grey-medium">Drag & drop Here</h6>
                  </div>
                </div>
              ) : (

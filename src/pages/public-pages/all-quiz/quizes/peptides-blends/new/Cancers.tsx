...
const Cancers = ({ onNext, onBack, defaultValues }: ICancersProps) => {
  ...
  return (
    <div className="px-4 pt-4 md:pt-10 lg:pt-16">
      ...
      >
        <div>
          <h2 className="text-center text-3xl font-poppins font-semibold text-foreground">Do you have a history of breast, ovarian, or other hormone-sensitive cancers?</h2>
                ...
                <Radio
                  ...
                  classNames={{
                    ...
                    label: `
                      ...
                      ${cancers === option ? "border-primary bg-white text-black" : "border-grey bg-transparent text-black"}
                    `,
                  }}
                  label={

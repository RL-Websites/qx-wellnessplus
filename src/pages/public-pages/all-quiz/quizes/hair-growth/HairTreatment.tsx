...
const HairTreatment = ({ onNext, onBack, defaultValues }: IHairTreatmentProps) => {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-center text-3xl font-poppins font-semibold text-foreground">Do you have a history of hair treatment?</h2>
              ...
              <Radio
                ...
                classNames={{
                  ...
                  label: `
                    ...
                    ${hairTreatment === option ? "border-primary bg-white text-black" : "border-grey bg-transparent text-black"}
                  `,
                }}
                label={

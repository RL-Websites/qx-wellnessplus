...
const ThyroidDisease = ({ onNext, onBack, defaultValues }: IThyroidDiseaseProps) => {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-center text-3xl font-poppins font-semibold text-foreground">Do you have severe uncontrolled thyroid disease? </h2>
              ...
              <Radio
                ...
                classNames={{
                  ...
                  label: `
                    ...
                    ${thyroidDisease === option ? "border-primary bg-white text-black" : "border-grey bg-transparent text-black"}
                  `,
                }}
                label={

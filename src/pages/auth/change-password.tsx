...
import { Button, Image, Input, PasswordInput, Text, Title } from "@mantine/core";
    ...
    <div className="auth">
      ...
      <div className="auth-content-col">
        <div className="auth-content-col-inner">
          <Title className="relative auth-title !pb-[11px] auth-underline !mb-[20px]">Reset Password</Title>
          <Text className="title-description">Enter a new password to reset the password on your account.</Text>
          <form
            className="w-full"
